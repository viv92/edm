...
if __name__ == '__main__':
    ...
    save_folder = './generated_muse_vae_transformer_edm_customDecoder_cfg_mnist' + hyperparam_str
    if not os.path.exists(save_folder):
        os.makedirs(save_folder)

    # vae ckpt path 
    vae_ckpt_path = '/home/vivswan/experiments/latent_diffusion/ckpts/VAE_transformer_mnist|Ldim:4|imgSize:28|patchSize:4|patchDim:16|seqLen:49|dModel:16|nHeads:8|dropout:0.1.pth' # path to pretrained vae 
    # t5 model (for encoding captions) 
    t5_model_name = 't5-base'
    # muse_vae_edm save ckpt path
    muse_ckpt_path = './ckpts/muse_vae_transformer_edm_customDecoder_cfg_mnist' + hyperparam_str + '.pt'
