...
if __name__ == '__main__':
    ...
    random_seed = 10
    sample_freq = int(total_train_steps / 200)
    ...
    save_folder = './generated_muse_fsq_transformer_edm_customDecoder_cfg_cifar' + hyperparam_str
    ...
    muse_ckpt_path = './ckpts/muse_fsq_transformer_edm_customDecoder_cfg_cifar' + hyperparam_str + '.pt'
